<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bookSubscription.aspx.cs" EnableViewState="true" Inherits="dayaxe.com.Subscriptions.BookSubscriptionPage" %>
...
<head runat="server">
    <title>Subscription Membership: Gold Pass - Unlimited Monthly Hotel Day Access | DayAxe</title>
    <meta charset="utf-8" />
    ...
    <!--bootstrap-->
    <webopt:bundlereference runat="server" path="~/Content/booksubscription" />
    ...
    <script>
        ...
        fbq('track', 'PageView');   
        fbq('track', 'AddToCart', {
            content_ids: ['<%=PublicSubscription!= null ? PublicSubscription.Id : 0 %>'],
            content_type: 'subscription',
            content_name: '<%=PublicSubscription.Name %>'
        });
...
/*]]>*/</script>
    ...
    <% if (AppConfiguration.EnableMixpanel) { %>
        ...
        <script type="text/javascript">
            ...
            mixpanel.register({
                "Subscription Name": "<%=PublicSubscription.Name %>",
                "Subscritpion Type": "<%=((Enums.SubscriptionType)PublicSubscription.SubscriptionType).ToString()%>",
                "Subscription Price": "$<%=PublicSubscription.Price.ToString(PublicSubscription.Price%1 == 0.0 ? "C0" : "C", new CultureInfo("en-US"))%>"
            });
            mixpanel.track("Subscription Purchase Started", { "referrer": document.referrer });
        </script>
    <% } %>
...
<div id="page-wrapper" class="book-page book-subscription-page">
<!-- Main -->
<article id="main">
    <header class="single">
        <div class="container">
    ...
    <section class="wrapper style5">
        <div id="owl-demo" class="owl-carousel owl-theme">
            <div class="item">
                <img src="<%=PublicSubscription != null ? PublicSubscription.ImageUrl : string.Empty %>" alt="Mirror Edge"/>
        ...
        <div class="modal-dialog vertical-align-c">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title text-center">Buying Extra?</h4>
                </div>
                <div class="modal-body text-center">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="location">
                                You already have an active membership. Only one membership per account is available. If you need to purchase another one please use a different account.
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div id="form-group">
                            <div class="input-group greenborder">
                                ...
                                <div class="row border" id="discountInfoRow" runat="server" Visible="False">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 padding-left-0 padding-right-0">
                            <div class="book book-md">
                                <div class="note" style="margin-left:10px; margin-right: 10px;">
                                    ...
                                    I agree to the <a class="blue" href="http://land.dayaxe.com/terms" target="_blank">Terms & Conditions</a>.
                                </div>
...
<script>
    ...
    _learnq.push(['track', 'Checked Out Subscription', {
        ...
        'item_name': '<%=PublicSubscription.Name%>',
        'item_id': '<%=PublicSubscription.Id %>',
        'item_guest_count': '<%=PublicSubscription.MaxGuest%>',
        'item_photo': '<%=(string.Format("{0}", new Uri(new Uri(AppConfiguration.CdnImageUrlDefault), PublicSubscription.ImageUrl).AbsoluteUri))%>',
        'item_price': '<%=PublicSubscription.Price%>',
...
<%: Scripts.Render("~/bundles/booksubscription") %>
</form>
</body>
</html>