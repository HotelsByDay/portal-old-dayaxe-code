<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AuthControl.ascx.cs" Inherits="dayaxe.com.Controls.AuthControl" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <div id="authModal" class="modal" role="dialog" data-keyboard="false" data-backdrop="static">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    <div class="row button-submit">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <asp:Button ID="SignInButton" runat="server" CssClass="btn btn-save" Text="Sign In" OnClick="SignInButtonClick" UseSubmitBehavior="false"/>
                                        </div>
                                    </div>
                                    <div class="row">
                        ...
                        <div class="modal-dialog vertical-align-c">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body text-center">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-20">
                                            <asp:TextBox ID="NewPassText" TextMode="Password" placeholder="New Password" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12 margin-bottom-15 confirm-password">
                                            <asp:TextBox ID="ConfirmPasswordText" TextMode="Password" placeholder="Confirm Password" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
